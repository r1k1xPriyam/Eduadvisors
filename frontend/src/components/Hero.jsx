...
const Hero = () => {
  ...
  return (
    <section id="home" className="pt-24 pb-16 bg-gradient-to-br from-yellow-50 via-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex items-center space-x-8 pt-4">
              <div>
                ...
                <p className="text-sm text-gray-600">Students Counselled</p>
              </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-6 -right-6 w-72 h-72 bg-yellow-200 rounded-full blur-3xl opacity-30 -z-10"></div>
            <div className="absolute -bottom-6 -left-6 w-72 h-72 bg-yellow-300 rounded-full blur-3xl opacity-20 -z-10"></div>
          </div>
        </div>
      </div>
    </section>
